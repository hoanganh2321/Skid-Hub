...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>discord.gg/XBHZUwqAzK<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Kaioshin Hub Premium!<Color=/>"):Display()
    wait(.14)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Channel : discord.gg/XBHZUwqAzK <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Kaioshin Hub", HidePremium = false, IntroText = "Heiskso Library", SaveConfig = true, ConfigFolder = "Kaioshin Hub"})
...
OrionLib:MakeNotification({
	Name = "Kaioshin Hub",
	Content = "Kaioshin Hub Not Skidder, Please don't says",
	Image = "rbxassetid://15992619207",
	Time = 25
})
...
W:AddLabel("[+] Kaioshin Hub is back!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Kaioshin Hub(Noitification)",
